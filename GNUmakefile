...
ifeq ($(LAB4GE),1)
  lock_tester += lock_client_cache.cc extent_client.cc
endif
ifeq ($(LAB7GE),1)
...
handin: 
	...
	@echo Please modify lab6.tgz to lab6_[your student id].tgz and upload it to ftp://ytliu.cc:public@public.sjtu.edu.cn/upload/lab6
	@echo Thanks!
